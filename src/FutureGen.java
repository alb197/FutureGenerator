...
public class FutureGen {
    ...
    public static void main(String[] args) {
        try {
            ...
            ArrayList<String> result = showResults();
            System.out.println("You will marry " + result.get(0).toString() + " and live in a beautiful " + result.get(4).toString() + " in " + result.get(1).toString() + ". ");
            System.out.println("You will drive home in your " + result.get(2).toString() + " with your " + result.get(5).toString() + " kids to pick up your adorable new " + result.get(3).toString());
            System.out.println(" ");
